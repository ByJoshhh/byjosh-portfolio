...
const STATIC_DATA = [
    ...
    { title: 'The Golden', cat: 'geometry-dash,thumbnails', img: '/images/GD%20thumbnails/The-Golden-New.webp', bg: 'linear-gradient(135deg, #1b4e2d, #0d140b)' },
    { title: 'Wasureta by Helpegasus', cat: 'featured,geometry-dash,thumbnails', img: '/images/GD%20thumbnails/Wasureta-By-Helpecasus.webp', bg: 'linear-gradient(135deg, #2d1b4e, #1a1e3a)', isNew: true },
    ...
    { title: 'Junkos Thumbnail 2', cat: 'featured,esports,thumbnails', img: '/images/E-SPORTS/JANKOS-THUMBNAIL2.webp', bg: 'linear-gradient(135deg, #ff758c, #1a1e3a)', isNew: true },
    { title: 'Junkos Unstoppable', cat: 'featured,esports,thumbnails', img: '/images/E-SPORTS/JUNKOS-THUMBNAIL3-final%20(1).webp', bg: 'linear-gradient(135deg, #6b3a2a, #1a1e3a)', isNew: true },
